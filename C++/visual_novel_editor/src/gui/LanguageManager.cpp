...
public:
    InlineTranslator()
    {
        const QHash<QString, QString> translations = {
            ...
            {makeKey("MainWindow", "Export canceled"), QStringLiteral("导出已取消")},
            {makeKey("MainWindow", "Exporting"), QStringLiteral("正在导出")},
            {makeKey("MainWindow", "Exporting Ren'Py script..."), QStringLiteral("正在导出 Ren'Py 脚本…")},
            ...
            {makeKey("MainWindow", "Create a new story node"), QStringLiteral("创建新剧情节点")},
            {makeKey("MainWindow", "Create a new story node (%1)"), QStringLiteral("创建新剧情节点（%1）")},
            {makeKey("MainWindow", "Open the script editor for the selected node"), QStringLiteral("打开所选节点的脚本编辑器")},
            {makeKey("MainWindow", "Open the script editor for the selected node (%1)"), QStringLiteral("打开所选节点的脚本编辑器（%1）")},
            {makeKey("MainWindow", "Generate a Ren'Py project from the current story"), QStringLiteral("基于当前故事生成 Ren'Py 项目")},
            {makeKey("MainWindow", "Generate a Ren'Py project from the current story (%1)"), QStringLiteral("基于当前故事生成 Ren'Py 项目（%1）")},
            ...
            {makeKey("NodeInspectorWidget", "Bold"), QStringLiteral("加粗")},
            {makeKey("NodeInspectorWidget", "Toggle bold formatting"), QStringLiteral("切换加粗格式")},
            {makeKey("NodeInspectorWidget", "Toggle bold formatting (%1)"), QStringLiteral("切换加粗格式（%1）")},
            {makeKey("NodeInspectorWidget", "Italic"), QStringLiteral("斜体")},
            {makeKey("NodeInspectorWidget", "Toggle italic formatting"), QStringLiteral("切换斜体格式")},
            {makeKey("NodeInspectorWidget", "Toggle italic formatting (%1)"), QStringLiteral("切换斜体格式（%1）")},
            {makeKey("NodeInspectorWidget", "Underline"), QStringLiteral("下划线")},
            {makeKey("NodeInspectorWidget", "Toggle underline formatting"), QStringLiteral("切换下划线格式")},
            {makeKey("NodeInspectorWidget", "Toggle underline formatting (%1)"), QStringLiteral("切换下划线格式（%1）")},
            {makeKey("NodeInspectorWidget", "Color"), QStringLiteral("颜色")},
            {makeKey("NodeInspectorWidget", "Choose the text color"), QStringLiteral("选择文本颜色")},
            {makeKey("NodeInspectorWidget", "Text color"), QStringLiteral("文本颜色")},
